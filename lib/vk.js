...
class VK{
     ...
     *
     * @param params
     * @param {string} [params.access_token]- access token, for community or user
     * @param {string} [params.username] - user username
     * @param {string} [params.password] - user password
     * @param {string} [params.group_id] - community only
     * @param {string} [params.confirmation] - community only
     * @param {string} [params.secret] - community only
     * @param {string} [params.port] - community only
     */
    constructor(params = {}){
        this.params = params;
